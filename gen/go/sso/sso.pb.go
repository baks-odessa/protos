...
func (x *LoginRequest) GetPassord() string {
	if x != nil {
		return x.Passord
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\apassord\x18\x02 \x01(\tR\apassord\x12\x15\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x1bZ\x19vyavtushenko.sso.v1;ssov1b\x06proto3"
